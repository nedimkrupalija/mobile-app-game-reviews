...
class GameDetailsFragment : Fragment() {
    ...
    private fun submitGameReview() {
        ...
        val review = GameReview( reviewRating.rating.toInt(),reviewEditText.text.toString(),game.id,true,AccountGamesRepository.Account.student,System.currentTimeMillis().toString())
        scope.launch {
